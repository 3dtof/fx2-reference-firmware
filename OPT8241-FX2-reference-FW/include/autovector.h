...
#define DISABLE_EP2PF() EP2FIFOIE &= ~bmBIT2

#define ENABLE_EP2PF() EP2FIFOIE |= bmBIT2
#define CLEAR_EP2PF() CLEAR_GPIF(); EP2FIFOIRQ=bmBIT2

#define ENABLE_EP2EF() EP2FIFOIE |= bmBIT1
#define CLEAR_EP2EF() CLEAR_GPIF(); EP2FIFOIRQ=bmBIT1

#define ENABLE_EP2FF() EP2FIFOIE |= bmBIT0
#define CLEAR_EP2FF() CLEAR_GPIF(); EP2FIFOIRQ=bmBIT0

#define ENABLE_EP6PF() EP6FIFOIE |= bmBIT2
#define CLEAR_EP6PF() CLEAR_GPIF(); EP6FIFOIRQ=bmBIT2

#define ENABLE_EP6EF() EP6FIFOIE |= bmBIT1
#define CLEAR_EP6EF() CLEAR_GPIF(); EP6FIFOIRQ=bmBIT1
...
#define CLEAR_GPIFWF() CLEAR_GPIF(); GPIFIRQ = 0x02;
